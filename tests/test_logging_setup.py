...
from pocket_id_exporter.logging_setup import JsonFormatter, setup_logging


@pytest.fixture(autouse=True)
def _reset_logging():
    yield
    # Clean up after every test so handlers don't leak between tests.
...
def test_urllib3_logger_clamped_to_warning_or_above():
    ...
    # urllib3 should be at WARNING even when root is DEBUG
